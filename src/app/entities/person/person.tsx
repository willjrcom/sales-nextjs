...
export default class Person {
    ...
    constructor(id: string = "", name: string = "", email: string = "", cpf: string = "", birthday: Date = new Date(), contact: Contact = new Contact(), address: Address = new Address(), likeTax: boolean = false) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.cpf = cpf;
