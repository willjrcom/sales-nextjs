...
const StockReport = () => {
    ...
    const { isFetching, isLoading, data: reportStock, refetch } = useQuery<StockReportComplete>({
                                ...
                                <tbody>
                                    {allStocks.length === 0 && (
                                        <tr className="border-t">
                                            <td className="px-4 py-2">Nenhum produto encontrado</td>
                                        </tr>
                                    )}
