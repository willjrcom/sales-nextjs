                ...
                <div className="flex justify-around mb-4">
                    <div className="mr-4">
                        <div className="flex items-center justify-between">
                            <PageTitle title="Organização de Mesas" tooltip="Arraste as mesas para configurar o layout do salão." />
                            <SelectField friendlyName="Ambiente" name="place" selectedValue={placeSelectedID} setSelectedValue={setPlaceSelectedID} values={places} optional />
                        </div>
